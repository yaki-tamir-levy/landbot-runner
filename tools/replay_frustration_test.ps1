...
$PatientPhone = '8007777701'
$PatientName  = 'בדיקת_תסכול'

# הרצף המדויק מהשיחה האמיתית עם בועז
$Messages = @(
    'היי מטפל',
    'ע מה נדבר היום?',
    'אני מרגיש לחוץ ונראה לי שאף אחד לא אוהב אותי. מה לעשות???',
    'זאת תשובה על השאלה שלי???',
    'תענה על השאלה שלי. זה הכל',
    'שאלתי מה לעשות???'
)
