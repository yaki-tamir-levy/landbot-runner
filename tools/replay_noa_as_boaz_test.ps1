...
# בדיוק אותו רצף הודעות מהשיחה האמיתית עם בועז - הפעם על נועה,
# כדי לבדוק אם המנגנון תופס את החזרה בלי תלות בזהות/רקע ספציפי
$Messages = @(
    'היי מטפל',
    'ע מה נדבר היום?',
    'אני מרגישה לחוצה ונראה לי שאף אחד לא אוהב אותי. מה לעשות???',
    'זאת תשובה על השאלה שלי???',
    'תעני על השאלה שלי. זה הכל',
    'שאלתי מה לעשות???'
)
