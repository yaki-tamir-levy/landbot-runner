...
$PatientPhone = '9990000003'
$PatientName  = 'שירן-סים-יונתן'

# אותו תסריט לחץ בדיוק כמו בועז - בקשה חוזרת ומתעצמת - הפעם על
# שירן, מטופלת NLP_CBT אמיתית שכבר מוגדרת כקצרת רוח ומתעצבנת
# מתרגילים, כדי לבדוק אם אותה בעיה קיימת בטראק הזה
$Messages = @(
    'היי מטפל',
    'על מה נדבר היום?',
    'אני מרגישה לחוצה ונראה לי שאף אחד לא אוהב אותי. מה לעשות???',
    'זאת תשובה על השאלה שלי???',
    'אני רוצה תשובה לשאלה שלי',
    'אני סומכת עליך שתעזור לי, אתה יכול?',
    'מה לעשות שאני מרגישה דחויה?',
    'לא מצאתי משהו שיעזור לי',
    'מה אכפת לי מאנשים, אני מדברת איתך כדי שאתה תעזור לי',
    'אין לי רעיון',
    'אתה סתם מקשקש ולא עוזר לי בכלל',
    'אני לא קובעת. אתה קובע. אני משלמת כדי שתעזור לי',
